  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center h-screen">
        <div className="flex flex-col w-3/5 p-8 space-y-8 transition-transform ease-in-out transform bg-gray-800 rounded-lg shadow-lg text-custom-blue duration-10000 hover:scale-105">
          <div className="space-y-4">
            <h1 className="font-mono text-lg text-center">About Us</h1> {/* Center align the "About Us" heading */}
            <div className="text-left about-content"> {/* Left align the content */}
              <h2>Who We Are</h2>
              <p>
      ...
      <div className="flex justify-center">
        <button
          className="px-4 py-2 font-bold text-white transition duration-300 ease-in-out transform bg-teal-500 rounded hover:scale-110 hover:bg-gray-600"
          onClick={() => {
            navigate("/");
          }}
        >
