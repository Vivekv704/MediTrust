    ...
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen space-y-6 p-6">
        ...
        <div className="text-center space-y-2">
          ...
          <h4 className="text-lg font-light text-gray-300">Select a Patient to add prescription</h4>
        </div>
          ...
          {patients.map((patient) => (
            <div key={patient.hhNumber} className="flex items-center justify-between p-4 bg-gray-800 rounded-lg shadow-lg">
              ...
              <div className="space-x-4">
                <Link 
                to={`/patient/${patient.hhNumber}/uploadreport`}
                className="px-6 py-3 bg-teal-500 text-white rounded-lg hover:bg-teal-600 transition-all duration-300">Add Prescription</Link>
              </div>
            </div>
          ))}
        </div>
